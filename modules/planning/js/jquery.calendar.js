...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            html.push("<table style=\"height: 756px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            for (var i = 0; i < l; i++) {
                ...
                // Today
                if (istoday) {
                    ht.push("<div style=\"margin-bottom: -756px; height:756px\" class=\"tg-today\">&nbsp;</div>");
                }
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                ht.push("<div  style=\"margin-bottom: -756px; height: 756px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
        ...
        function gP(h, m) {
            return (h-6) * 42 + parseInt(m / 60 * 42);
        }
        function gW(ts1, ts2) {
            var t1 = ts1 / 42;
            var t2 = parseInt(t1);
        ...
        function gH(y1, y2, pt) {
            ...
            var t5 = parseInt(t4);
            var t6 = t4 - t5 >= 0.5 ? 30 : 0;
            return { sh: t2+6, sm: t3, eh: t5+6, em: t6, h: sy2 - sy1 };
        }
        function pZero(n) {
            return n < 10 ? "0" + n : "" + n;
        }
